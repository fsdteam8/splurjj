...
type ContentItem = {
  ...
  user_id: number;
  status: string;
  image2: string[] | string; // ✅ sometimes array, sometimes JSON string
  image2_url: string[];
  ...
  return (
    <div className="pb-20">
      ...
      <div className="flex items-center gap-2">
        <h3 className="text-2xl font-semibold text-black leading-normal">Author :</h3>
      ...
      <div className="flex items-center gap-2">
        <h3 className="text-2xl font-semibold text-black leading-normal">Date :</h3>
        <p className="text-xl font-medium text-black leading-normal">
          {data?.data?.date}
        </p>
      </div>
      ...
      <div className="flex items-center gap-2">
        <h3 className="text-2xl font-semibold text-black leading-normal">Tags :</h3>
        <p className="text-xl font-medium text-black leading-normal">
      ...
      <h5
        ...
        dangerouslySetInnerHTML={{ __html: data?.data?.sub_heading ?? "" }}
      />
